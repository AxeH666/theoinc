...
import { getRole as getBackendRole, clearAuth } from '../utils/auth';

const mapBackendRoleToUiRole = (role: string | null | undefined): Role => {
  switch (role) {
    case 'ADMIN':
      return 'Admin';
    case 'CREATOR':
...
const App: React.FC = () => {
  ...
  const [currentRole] = useState<Role>(() => mapBackendRoleToUiRole(getBackendRole()));
